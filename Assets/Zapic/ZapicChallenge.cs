...
/// <summary>A Zapic challenge.</summary>
/// <remarks>Added in 1.3.0.</remarks>
public sealed class ZapicChallenge
{
    /// <summary>A value indicating whether the challenge is active.</summary>
    ...
    /// <summary>The current rank.</summary>
    ...
    private readonly ZapicChallengeStatus status;

    /// <summary>The title.</summary>
    private readonly string title;

    /// <summary>The total number of users that have accepted the invitation to join the challenge.</summary>
    private readonly long totalUsers;

    /// <summary>Initializes a new instance of the <see cref="ZapicChallenge"/> class.</summary>
    /// <param name="id">The unique identifier.</param>
    /// <param name="title">The title.</param>
    /// <param name="description">The description.</param>
    /// <param name="metadata">The custom metadata.</param>
    /// <param name="active">A value indicating whether the challenge is active.</param>
    ...
    /// <summary>
    ///     <para>Gets a value indicating whether the challenge is active.</para>
    ///     <para>
    ...
    ///     <para>This is used as a longer, detailed description of the challenge.</para>
    /// </summary>
    /// <remarks>Added in 1.3.0.</remarks>
    ...
    /// <summary>
    ///     Gets the current rank or <c>null</c> if the player has not accepted the invitation to join the challenge.
    /// </summary>
    /// <remarks>Added in 1.3.0.</remarks>
    public long? Rank
    {
    ...
    /// <summary>
    ///     Gets the current score or <c>null</c> if the player has not accepted the invitation to join the challenge or
    ...
    /// <remarks>Added in 1.3.0.</remarks>
    public ZapicChallengeStatus Status
    {
        get
        {
            return status;
    ...
    ///     <para>This is used as a shorter, summary description of the challenge.</para>
    /// </summary>
    /// <remarks>Added in 1.3.0.</remarks>
    public string Title
    {
    ...
    /// <summary>Gets the total number of users that have accepted the invitation to join the challenge.</summary>
    /// <remarks>Added in 1.3.0.</remarks>
